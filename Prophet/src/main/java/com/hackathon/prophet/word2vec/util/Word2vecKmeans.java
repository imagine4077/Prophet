package com.hackathon.prophet.word2vec.util;
...
public class Word2vecKmeans{
    ...
    /*public static void main(String[] args) throws IOException {
        ...
        Word2vecKmeans wordKmeans = new Word2vecKmeans(vec.getWordMap(), 50, 50);
    ...
    public Word2vecKmeans(HashMap<String, float[]> wordMap, int clcn, int iter) {
