package com.hackathon.prophet.word2vec;

import com.hackathon.prophet.word2vec.domain.HiddenNeuron;
import com.hackathon.prophet.word2vec.domain.Neuron;
import com.hackathon.prophet.word2vec.domain.WordNeuron;
import com.hackathon.prophet.word2vec.util.Haffman;
import com.hackathon.prophet.word2vec.util.MapCount;
...
public class Word2vecLearn {
    ...
    public Word2vecLearn(Boolean isCbow, Integer layerSize, Integer window, Double alpha,
                 Double sample) {
        createExpTable();
        if (isCbow != null) {
            this.isCbow = isCbow;
